...
mycon= sql.connect(host="localhost",user="root",password="ayanbanik@2007",database="banking1")
mycur= mycon.cursor()
while True:
    print("\n")
        ...
        if(ch==2):
            ...
            if data:
                while True:
                    ...
                    print("\n")
                    print("___________________________________________________________________________")
                    print("*************** Welcome To Mriganka Bank Of India : *************************")
                    print("___________________________________________________________________________")
                    print("\n")
                    ...
                    if(ch1==1):
                        ...
                        print("*************Thanks For Choosing Mriganka Bank Of India *****************")
                        print("____________________________________________________________________________")
                        exit()
